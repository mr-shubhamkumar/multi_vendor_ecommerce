...
<head>
    <meta charset="utf-8" />
    <title>Vendor Register - Shubham  Online Store</title>
                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        <div class="heading_s1">
                                            ...
                                            <p class="mb-30">Vendor Already have an account? <a href="{{route('vendor.login')}}">Vendor Login</a></p>
                                        </div>
                             <form method="POST" action="{{ route('vendor.register') }}">
                              @csrf
                              <!-- name -->
                                <div class="form-group">
                                    <input id="name" type="text" name="name" required="" placeholder="Shop Name" />
                                </div>
                                <!-- username -->
                                <div class="form-group">
