                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{ !empty($vendorData->photo) ? url('uploade/vendor_images/' . $vendorData->photo) : url('uploade/no_image.jpg') }}"
                    ...
                    <form action="{{ route('vendor.profile.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <img id="showImage"
                                    src="{{ !empty($vendorData->photo) ? url('uploade/vendor_images/' . $vendorData->photo) : url('uploade/no_image.jpg') }}"
