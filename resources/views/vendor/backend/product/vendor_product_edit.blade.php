...
<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Edite Vendor Product</div>
					<div class="ps-3">
...
<div class="card">
  <div class="card-body p-4">
	  <h5 class="card-title">Edite Product</h5>
	  <hr/>
...
{{--Mian Thumbnail Image Edit Section Start --}}
<div class="page-content">
...
{{-- Mutli image Edit section Start --}}
<div class="page-content">
...
@csrf
           @foreach($multiImg as $key => $img)
			<tr>
				...
				<td><img src="{{asset($img->photo_name)}}" width="70" height="70px"></td>
