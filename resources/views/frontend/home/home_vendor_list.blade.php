                    ...
                    <div class="vendor-img-action-wrap">
                        <div class="vendor-img">
                            <a href="{{ route('vendor.details',$vendor->id)}}">
                                <img class="default-img" src=" {{ !empty($vendor->photo) ? url('uploade/vendor_images/' . $vendor->photo) : url('uploade/no_image.jpg') }}" alt="" />
                            </a>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-end mb-30">
                            <div>
                                ...
                                <div class="product-rate-cover">
                                   @php
                                   $vendor_product = App\Models\Product::where('vendor_id',$vendor->id)->get();
                                   @endphp
                                   <span class="font-small total-product">{{count($vendor_product)}} products</span>
                                </div>
                            </div>
