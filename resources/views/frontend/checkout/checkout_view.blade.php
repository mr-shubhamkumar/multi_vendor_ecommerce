...
@section('main')
 ...
 <div class="page-header breadcrumb-wrap">
    ...
    <div class="row">
        ...
        <form method="post" action="{{ route('checked.store')}}">
            @csrf
     ...
     <div class="row shipping_calculator">
        ...
        <div class="form-group col-lg-6">
            <input required="" type="text" name="shipping_pincode" placeholder="Post Code *">
        </div>
    </div>
    ...
    <div class="table-responsive order_table checkout">
        <table class="table no-border">
            <tbody>
                ...
                <tr>
                    <td class="image product-thumbnail"><img style="width: 50px; height: 50px" src="{{$item->options->image}}" alt="#"></td>
                    <td>
...
<script type="text/javascript">
        ...
        $(document).ready(function(){
            $('select[name="state_id"]').on('change', function(){
                ...
                if (state_id) {
                    $.ajax({
                        url: "{{ url('/district/ajax') }}/"+state_id,
                        type: "GET",
                        dataType:"json",
