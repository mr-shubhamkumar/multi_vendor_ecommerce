            ...
            <div class="container">
                <div class="archive-header">
                    <div class="row align-items-center">
                        <div class="col-xl-3">
                            <h5 class="mb-15">{{$bredsubcat->subcategory_name}}</h5>
                            <div class="breadcrumb">
                                <a href="index.html" rel="nofollow"><i class="fi-rs-home mr-5"></i>Home</a>
                                <span></span> Category <span></span> {{$bredsubcat->subcategory_name}}
                            </div>
                        </div>
    ...
    @foreach($product as $product)
                        ...
                        <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <h2><a href="{{url('product/details/'.$product->id.'/'.$product->product_slug)}}">{{ Illuminate\Support\Str::limit($product->product_name, 20) }}</a></h2>
                                ...
                                <div class="product-card-bottom">
                                    ...
                                    <div class="add-cart">
                                        <a class="add" href="{{url('product/details/'.$product->id.'/'.$product->product_slug)}}"><i class="fi-rs-shopping-cart "></i>Details </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="sidebar-widget product-sidebar mb-30 p-30 bg-grey border-radius-10">
                        ...
                        <div class="single-post clearfix">
                            ...
                            <div class="content pt-10">
                                <h5><a href="{{url('product/details/'.$product->id.'/'.$product->product_slug)}}">{{ Illuminate\Support\Str::limit($product->product_name, 10) }}</a></h5>
                                  @if($product->discount_price == NULL)
