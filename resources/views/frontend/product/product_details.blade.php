        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> <a href="shop-grid-right.html"> {{$product['category']['category_name']}} </a> <span>{{$product['subcategory']['subcategory_name']}}</span> <span> </span> {{ $product->product_name}}
                </div>
            </div>
        </div>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
                                <div class="detail-gallery">
                                    ...
                                    <div class="slider-nav-thumbnails">
                                        @foreach($multiImag as $multiImags)
                                        <div><img src="{{ asset($multiImags->photo_name)}}" alt="product image" /></div>
                                        @endforeach
                                    </div>
                                </div>
                                <!-- End Gallery -->
                          ...
                          @endphp
                            ...
                            <div class="font-xs">
                                <ul class="mr-50 float-start">
                                    ...
                                    <li class="mb-5">Ctegory:<span class="text-brand"> {{$product['category']['category_name']}}</span></li>
                                ...
                                <div class="tab-content shop_info_tab entry-main-content">
                                    ...
                                    <div class="tab-pane fade" id="Vendor-info">
                                        <div class="vendor-logo d-flex mb-30">
                                            <img src="{{ !empty($product->vendor->photo) ? url('uploade/vendor_images/' . $product->vendor->photo) : url('uploade/no_image.jpg') }}" alt="" />
                                            <div class="vendor-name ml-15">
                                                @if($product->vendor_id == NULL)
                                                <h6>
                                                    <a href="vendor-details-2.html">Ower</a>
                                                </h6>
                                                @else
                                                <h6>
                                        ...
                                        <ul class="contact-infor mb-50">
                                            <li><img src="assets/imgs/theme/icons/icon-location.svg" alt="" /><strong>Address: </strong> <span>Owenr Address</span></li>
                                            <li><img src="assets/imgs/theme/icons/icon-contact.svg" alt="" /><strong>Contact Seller:</strong><span>(+91) Owner Address></li>
                                        </ul>
                                        @else
                                         <ul class="contact-infor mb-50">
                                ...
                                <div class="row related-products">
                                        ...
                                        <div class="product-cart-wrap hover-up">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="{{url('product/details/'.$product->id.'/'.$relatedProduct->product_slug)}}" tabindex="0">
                                    ...
                                    @endif
                                            ...
                                            <div class="product-content-wrap">
                                                <h2><a href="shop-product-right.html" tabindex="0">{{ Illuminate\Support\Str::limit($relatedProduct->product_name, 5) }}</a></h2>
