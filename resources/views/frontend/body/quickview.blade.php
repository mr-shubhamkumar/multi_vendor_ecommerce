                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="detail-info pr-30 pl-30">
                                <h5 class="title-detail"><a href=" " id="pname" class="text-heading"> </a></h3>
                                     ...
                                     <div class="col-md-6">
                                        <div class="font-xs">
                                            <ul>
                                                ...
                                                <li class="mb-5">Stock:
                                                    <span class="rounded Badge badge-pill badge-success" id="aviable" style="background: green; color: white; "> </span>
                                                    <span class="rounded Badge badge-pill badge-danger" id="stockout" style="background: red; color: white;"> </span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div> <!-----// End col ----->
